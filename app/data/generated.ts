export const DATA_SNAPSHOT = {
  ...
  "teachers": [
    ...
    {
      "name": "Логинова-Цветкова Анастасия",
      "firstName": "Анастасия",
      "assignments": [
        {
          "sourceSheet": "Дизайн",
